...
> 2026-09-09 이후의 최신 전체 상태는 `FULL_HANDOFF_AUDIT_2026-09-09.md`를 따른다. 특히 문화유산은 `79eeaca`의 다학교 자율 Game ID 방식까지 배포됐고, Functions 종속성 취약점과 퀴즈타운 내부 배포 차이를 새 보고서에서 다시 분류했다. 아래 표의 과거 “앞섬” 표시는 당시 실행 이력이다.
