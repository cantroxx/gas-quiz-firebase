...
const SCIENCE_GENERAL = [
  ...
  ['식물에서 광합성이 주로 일어나는 부분은 어디인가요?', '잎', ['잎', '뿌리', '줄기', '씨'], '잎은 햇빛을 받아 양분을 만드는 데 중요합니다.'],
  ...
  ['공기 중 물이 차가운 컵 겉면에 맺혀 생기는 것은 무엇인가요?', '물방울', ['물방울', '얼음 조각', '모래 알갱이', '철가루'], '수증기가 차가워져 물방울이 됩니다.'],
  ...
  ['물체가 움직일 때 표면끼리 닿아 움직임을 방해하는 힘은 무엇인가요?', '마찰력', ['마찰력', '부력', '탄성', '자기력'], '표면이 거칠수록 마찰력이 커질 수 있습니다.'],
  ['지구가 물체를 아래로 끌어당기는 힘은 무엇인가요?', '중력', ['중력', '마찰력', '전류', '기압'], '중력 때문에 물체가 아래로 떨어집니다.'],
  ['물속에서 물체를 위로 밀어 올리는 힘은 무엇인가요?', '부력', ['부력', '중력', '마찰력', '탄성'], '배가 물에 뜨는 것과 관련 있는 힘입니다.'],
  ['고무줄처럼 모양이 변했다가 다시 돌아가려는 성질은 무엇인가요?', '탄성', ['탄성', '용해', '퇴적', '반사'], '고무줄과 용수철에서 쉽게 볼 수 있습니다.'],
  ['잡아당기거나 누르면 길이가 변하는 나선 모양의 도구는 무엇인가요?', '용수철', ['용수철', '나침반', '온도계', '저울'], '탄성을 이용해 힘을 알아볼 때 쓰입니다.'],
  ['전기 회로에서 전기를 공급하는 장치는 무엇인가요?', '전지', ['전지', '스위치', '전구', '전선'], '건전지는 전지를 생활 속에서 쓰는 예입니다.'],
  ['전기 회로에서 전기가 흐르는 것을 무엇이라고 하나요?', '전류', ['전류', '기압', '습도', '강수'], '전류가 흐르면 전구가 켜질 수 있습니다.'],
  ['전기 회로를 열고 닫아 전류를 조절하는 장치는 무엇인가요?', '스위치', ['스위치', '전지', '전구', '나침반'], '스위치를 닫으면 회로가 이어집니다.'],
  ['전구를 한 줄로 이어 연결하는 방법은 무엇인가요?', '직렬 연결', ['직렬 연결', '병렬 연결', '공전', '자전'], '한 줄로 이어져 있어 하나가 끊어지면 전체가 꺼질 수 있습니다.'],
  ['전구를 여러 갈래로 나누어 연결하는 방법은 무엇인가요?', '병렬 연결', ['병렬 연결', '직렬 연결', '퇴적', '침식'], '각 전구가 서로 다른 길로 연결됩니다.'],
  ['옛날 생물의 몸이나 흔적이 암석에 남은 것은 무엇인가요?', '화석', ['화석', '그림자', '이슬', '소금물'], '공룡 발자국도 화석이 될 수 있습니다.'],
  ['흙이나 모래가 층층이 쌓여 생긴 줄무늬 모양의 땅속 구조는 무엇인가요?', '지층', ['지층', '은하', '관절', '줄기'], '지층을 보면 땅의 과거 모습을 짐작할 수 있습니다.'],
  ['모래나 진흙 등이 쌓여 굳어져 만들어진 암석은 무엇인가요?', '퇴적암', ['퇴적암', '화강암', '현무암', '변성암'], '층이 보이거나 화석이 들어 있기도 합니다.'],
  ['암석이 높은 열과 압력을 받아 성질이 달라진 암석은 무엇인가요?', '변성암', ['변성암', '퇴적암', '현무암', '화강암'], '기존 암석이 변하여 만들어집니다.'],
  ['땅속 깊은 곳에 있는 녹은 암석 물질은 무엇인가요?', '마그마', ['마그마', '용암', '화산재', '지층'], '땅속에 있을 때는 마그마라고 부릅니다.'],
  ['화산이 분출할 때 땅 밖으로 나온 마그마는 무엇인가요?', '용암', ['용암', '마그마', '화산재', '화석'], '땅 밖으로 나오면 용암이라고 부릅니다.'],
  ['화산이 폭발할 때 잘게 부서져 날리는 물질은 무엇인가요?', '화산재', ['화산재', '꽃가루', '모래 알갱이', '철가루'], '화산재는 바람을 타고 멀리 이동할 수 있습니다.'],
  ['땅이 흔들리는 자연 현상은 무엇인가요?', '지진', ['지진', '해일', '공전', '응고'], '지진이 나면 흔들림에 대비해야 합니다.'],
  ['지진이 처음 발생한 땅속 지점은 무엇인가요?', '진원', ['진원', '기압', '습도', '서식지'], '진원 위의 지표 지점은 진앙이라고 합니다.'],
  ['바다 밑 지진 등으로 큰 물결이 밀려오는 현상은 무엇인가요?', '해일', ['해일', '구름', '강수', '바람'], '해안가에서 특히 조심해야 하는 자연 현상입니다.'],
  ['스스로 빛을 내는 천체는 무엇인가요?', '별', ['별', '행성', '위성', '화석'], '태양도 별입니다.'],
  ['별 주위를 도는 비교적 큰 천체는 무엇인가요?', '행성', ['행성', '별', '위성', '은하'], '지구는 태양 주위를 도는 행성입니다.'],
  ['행성 주위를 도는 천체는 무엇인가요?', '위성', ['위성', '행성', '별', '은하'], '달은 지구의 위성입니다.'],
  ['지구에 빛과 열을 주는 가장 가까운 별은 무엇인가요?', '태양', ['태양', '달', '화성', '금성'], '태양은 지구 생명 활동에 큰 영향을 줍니다.'],
  ['수많은 별과 가스, 먼지가 모여 있는 큰 집단은 무엇인가요?', '은하', ['은하', '지층', '생태계', '기압'], '우리가 속한 은하는 우리은하입니다.'],
  ['공기가 누르는 힘을 무엇이라고 하나요?', '기압', ['기압', '습도', '강수', '중력'], '기압은 날씨 변화와 관련이 있습니다.'],
  ['작은 물방울이나 얼음 알갱이가 하늘에 모여 보이는 것은 무엇인가요?', '구름', ['구름', '해일', '화산재', '지층'], '구름은 비나 눈이 될 수 있습니다.'],
  ['비, 눈, 우박처럼 하늘에서 땅으로 떨어지는 물을 통틀어 무엇이라고 하나요?', '강수', ['강수', '습도', '기압', '증산 작용'], '강수량은 비나 눈이 내린 양을 나타냅니다.'],
  ['공기 중에 들어 있는 수증기의 정도는 무엇인가요?', '습도', ['습도', '기압', '강수', '온도'], '습도가 높으면 공기가 눅눅하게 느껴질 수 있습니다.'],
  ['날씨를 관측하고 예보하는 기관은 무엇인가요?', '기상청', ['기상청', '소방서', '도서관', '박물관'], '기상청은 날씨 정보를 알려 줍니다.'],
  ['식물의 잎에서 물이 수증기로 빠져나가는 작용은 무엇인가요?', '증산 작용', ['증산 작용', '광합성', '용해', '응고'], '증산 작용은 식물 속 물의 이동과 관련 있습니다.'],
  ['식물에서 물과 양분이 이동하는 통로 역할을 하는 부분은 무엇인가요?', '줄기', ['줄기', '잎', '뿌리', '꽃'], '줄기는 식물을 지탱하고 물질을 이동시킵니다.'],
  ['식물에서 씨를 만들기 위해 피는 부분은 무엇인가요?', '꽃', ['꽃', '줄기', '뿌리', '잎'], '꽃은 번식과 관련 있는 기관입니다.'],
  ['식물이 싹트기 전 어린 식물이 들어 있는 것은 무엇인가요?', '씨앗', ['씨앗', '열매', '꽃가루', '애벌레'], '씨앗은 알맞은 조건에서 싹이 틉니다.'],
  ['식물에서 씨를 보호하거나 퍼뜨리는 데 도움을 주는 부분은 무엇인가요?', '열매', ['열매', '꽃가루', '줄기', '뿌리'], '사과와 복숭아는 열매의 예입니다.'],
  ['꽃에서 수분에 필요한 가루 모양의 물질은 무엇인가요?', '꽃가루', ['꽃가루', '화산재', '철가루', '모래 알갱이'], '꽃가루가 옮겨져 씨가 만들어질 수 있습니다.'],
  ['몸이 머리, 가슴, 배로 나뉘고 다리가 여섯 개인 동물 무리는 무엇인가요?', '곤충', ['곤충', '어류', '조류', '포유류'], '나비와 개미는 곤충입니다.'],
  ['생물 사이에서 먹고 먹히는 관계를 이어 나타낸 것은 무엇인가요?', '먹이 사슬', ['먹이 사슬', '생태계', '서식지', '보호색'], '먹이 사슬은 에너지의 이동을 보여 줍니다.'],
  ['스스로 양분을 만들어 먹이 사슬의 시작이 되는 생물은 무엇인가요?', '생산자', ['생산자', '소비자', '분해자', '포식자'], '식물은 대표적인 생산자입니다.'],
  ['다른 생물을 먹고 살아가는 생물은 무엇인가요?', '소비자', ['소비자', '생산자', '분해자', '꽃가루'], '동물은 보통 소비자에 속합니다.'],
  ['죽은 생물이나 배설물을 잘게 분해하는 생물은 무엇인가요?', '분해자', ['분해자', '생산자', '소비자', '위성'], '버섯과 세균은 분해자 역할을 합니다.'],
  ['생물이 살아가는 장소를 무엇이라고 하나요?', '서식지', ['서식지', '생태계', '지층', '진원'], '연못은 개구리의 서식지가 될 수 있습니다.'],
  ['생물과 그 생물이 사는 환경이 서로 영향을 주고받는 전체는 무엇인가요?', '생태계', ['생태계', '은하', '지층', '전기 회로'], '숲과 연못은 생태계로 볼 수 있습니다.'],
  ['주변 색이나 무늬와 비슷해 몸을 숨기는 데 도움이 되는 색은 무엇인가요?', '보호색', ['보호색', '꽃가루', '화산재', '반사'], '보호색은 천적을 피하는 데 도움이 됩니다.'],
  ['새나 곤충이 어린 생명을 품고 있는 둥근 것은 무엇인가요?', '알', ['알', '씨앗', '열매', '화석'], '병아리는 달걀에서 깨어납니다.'],
  ['곤충이 알에서 깨어난 뒤 어른벌레가 되기 전 먹이를 많이 먹는 시기는 무엇인가요?', '애벌레', ['애벌레', '번데기', '알', '어른벌레'], '나비의 애벌레는 잎을 먹으며 자랍니다.'],
  ['나비처럼 애벌레가 어른벌레로 변하기 전 거치는 시기는 무엇인가요?', '번데기', ['번데기', '애벌레', '알', '씨앗'], '번데기 안에서 몸의 모양이 크게 바뀝니다.'],
  ['알, 애벌레, 번데기, 어른벌레 단계를 거치는 변화를 무엇이라고 하나요?', '완전 탈바꿈', ['완전 탈바꿈', '불완전 탈바꿈', '증산 작용', '직렬 연결'], '나비와 모기는 완전 탈바꿈을 합니다.'],
  ['알, 어린벌레, 어른벌레처럼 번데기 단계가 없는 변화를 무엇이라고 하나요?', '불완전 탈바꿈', ['불완전 탈바꿈', '완전 탈바꿈', '병렬 연결', '공전'], '메뚜기는 불완전 탈바꿈을 합니다.'],
  ['음식물이 몸에 흡수될 수 있게 작게 분해되는 과정은 무엇인가요?', '소화', ['소화', '순환', '호흡', '증산 작용'], '소화는 여러 소화 기관에서 일어납니다.'],
  ['음식물이 잠시 머물며 소화액과 섞이는 주머니 모양 기관은 무엇인가요?', '위', ['위', '폐', '심장', '큰창자'], '위에서는 음식물이 더 잘게 소화됩니다.'],
  ['소화된 영양소가 주로 흡수되는 기관은 무엇인가요?', '작은창자', ['작은창자', '큰창자', '위', '입'], '작은창자는 길고 영양소 흡수에 중요합니다.'],
  ['남은 음식물에서 물이 주로 흡수되는 기관은 무엇인가요?', '큰창자', ['큰창자', '작은창자', '위', '폐'], '큰창자는 물을 흡수해 배설물을 만듭니다.'],
  ['피가 온몸을 돌아다니는 길 역할을 하는 것은 무엇인가요?', '혈관', ['혈관', '관절', '근육', '뼈대'], '혈관을 통해 피가 이동합니다.'],
  ['뼈와 뼈가 만나는 부분은 무엇인가요?', '관절', ['관절', '근육', '혈관', '뼈대'], '무릎과 팔꿈치에는 관절이 있습니다.'],
  ['뼈를 움직이게 해 몸을 움직이는 데 도움을 주는 것은 무엇인가요?', '근육', ['근육', '혈관', '관절', '소화'], '근육이 줄어들고 늘어나며 몸이 움직입니다.'],
  ['몸을 지탱하고 중요한 기관을 보호하는 뼈의 전체 구조는 무엇인가요?', '뼈대', ['뼈대', '근육', '혈관', '관절'], '뼈대는 몸의 모양을 잡아 줍니다.'],
  ['물체의 따뜻하고 차가운 정도를 나타내는 것은 무엇인가요?', '온도', ['온도', '습도', '기압', '밀도'], '온도는 온도계로 잴 수 있습니다.'],
  ['물체가 차지하는 공간의 크기는 무엇인가요?', '부피', ['부피', '무게', '밀도', '기압'], '부피는 담는 그릇의 크기와 관련이 있습니다.'],
  ['같은 부피에 들어 있는 물질의 양을 나타내는 성질은 무엇인가요?', '밀도', ['밀도', '부피', '온도', '습도'], '밀도는 물체가 뜨고 가라앉는 것과 관련 있습니다.']
];
...
function buildScienceGeneralQuestions() {
  return SCIENCE_GENERAL.map(([prompt, correct, choices, hint], index) => makeChoiceQuestion(
    'science-general',
    index + 1,
    buildDirectSciencePrompt(prompt, 0),
    correct,
    choices,
    hint || '',
    ''
...
const QUIZ_DEFINITIONS = [
  ...
  { quizId: 'science-general', title: '과학 상식 퀴즈', subject: '과학', subjectGroup: 'science', order: 60, expectedQuestionCount: SCIENCE_GENERAL.length, cycleQuestionCount: SCIENCE_GENERAL.length, description: '초등학생이 알아두면 좋은 생활 과학 상식을 확인합니다.', questions: buildScienceGeneralQuestions },
