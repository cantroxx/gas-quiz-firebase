...
const page=await browser.newPage({viewport:{width:1180,height:900},hasTouch:true}),errors=[];page.on('pageerror',e=>errors.push(e.message));await page.goto('http://127.0.0.1:5478/fraction-world/');await page.click('#enter-tower');await page.click('#tower-start');await page.evaluate(()=>{FWStore.get().tower=FWTowerDomain.create('wand');FWTower.enter();});
